...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 23, 2020 at 09:57 AM
...
CREATE TABLE `home_page_banners` (
  ...
  `text_fifth` text COLLATE utf8mb4_unicode_ci,
  `text_forth` text COLLATE utf8mb4_unicode_ci,
  `text_third` text COLLATE utf8mb4_unicode_ci,
  `text_second` text COLLATE utf8mb4_unicode_ci,
  `text_first` text COLLATE utf8mb4_unicode_ci,
  `image` text COLLATE utf8mb4_unicode_ci,
  `slug` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '1 = Active, 0 = Inactive',
  `deleted_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `home_page_banners` (`id`, `title`, `url`, `button_text`, `text_fifth`, `text_forth`, `text_third`, `text_second`, `text_first`, `image`, `slug`, `status`, `deleted_at`, `created_by`, `updated_by`, `deleted_by`, `created_at`, `updated_at`) VALUES
(1, 'Nice To Buy', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'public/upload/home-page-banner/bDuCLa7M6cam0PPKywAm.png', 'nice-to-buy-17', 1, NULL, 1, 1, NULL, '2020-07-12 00:26:06', '2020-07-20 22:34:32'),
(2, 'Nothing to say', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'public/upload/home-page-banner/SACVPDtek0KNoFQ81xlv.png', 'nothing-to-say-72', 1, NULL, 1, 1, NULL, '2020-07-12 00:27:47', '2020-07-20 22:49:17'),
(3, 'Malaysia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'public/upload/home-page-banner/6zpF9oTyRCoZbsRRrB9g.png', 'malaysia-11', 1, NULL, 1, 1, NULL, '2020-07-12 00:28:34', '2020-07-20 22:39:29');
...
(209, '2020_07_20_052110_add_vendor_id_to_product_comments_table', 42),
(210, '2020_07_20_052337_add_vendor_id_to_product_reviews_table', 42),
(211, '2020_07_20_071154_add_rating_to_product_table', 42),
(212, '2020_07_22_104323_create_newsletters_table', 42),
(213, '2020_07_22_134414_add_text_home_page_banners_table', 42);
...
INSERT INTO `product_reviews` (`id`, `product_id`, `user_id`, `vendor_id`, `review`, `review_image`, `rating`, `status`, `approved_by`, `created_by`, `updated_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 200712000000002, 5, NULL, 'Valo product', '', 5, 1, NULL, 5, 1, '2020-07-17 09:14:38', '2020-07-17 09:57:34', NULL);
