...
<header id="header_part" class="header_part">
    ...
    <div class="header_middle">
        <div class="container mobile_menu_sm">
                    ...
                    <div class="mobile_menu_section">
                        <nav class="navigation">
                            ...
                            <div class="menu">
                                ...
                                <nav class="navbar navbar-expand-sm main_nav_mobile ">
                                    <!-- Brand -->
                                    <div class="mobile_menu_logo_part d-flex ">
                                        <a class="navbar-brand" href="{{route('home.index')}}"><img
                                                src="{{asset($globalData['siteSetting']->logo)}}" alt=""
                                                class="img-fluid"></a>
                                        <button class="btn btn-sm menu_close_btn "><i class="fas fa-times"></i></button>
                                    </div>
                                    ...
                                    <ul class="navbar-nav">
                                        ...
                                        <!-- Dropdown -->
                                        <li class="nav-item dropdown nav_item_li">
                                            <a class="nav-link dropdown-toggle" href="#" id="navbardrop"
                                                data-toggle="dropdown">
                                                {{$item->category_name}}
                                            </a>
                                            <div class="dropdown-menu">
                                                <div class="dropdown_single_col">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-lg-3 d-flex justify-content-between large_menu_nav">
                <div class="logo_part">
                    <a href="{{route('home.index')}}"><img src="{{asset($globalData['siteSetting']->logo)}}" alt=""
                            class="img-fluid"></a>
                </div>
            ...
            <div class="col-lg-7 col-md-8 col-sm-8 col-8 mobile_seach_option_1">
                <div class="search_option">
                    <form method="GET" action="{{route('product.search')}}" class="d-flex search_form_1">
                        <div class="input-group">
                            ...
                            <div class="input-group-append input-group-append-mobile">
            ...
            @endphp
            <div class="col-lg-2 col-md-5 ml-md-auto col-sm-4 col-4">
                                ...
                                <ul class="list-unstyled px-2 pt-2">
                                            ...
                                            <ul class="list-unstyled d-flex ">
                                                ...
                                                <li class="li_text">
                                                    ...
                                                    <span class="font-size-14">1 ×
                                                        ${{$wishList->product->sell_price}}</span>
                                                </li>
                                                <li class="li_close">
                                                    <a href="{{route('wishlist.remove',$wishList->id)}}"
                                                        class="text-gray-90"><i class="fas fa-times"></i></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li class="border-bottom pb-2 mb-3">
                                        <div class="">
                                            <ul class="list-unstyled d-flex ">
                                                <li class="li_text">
                                                    <h5 class="text-blue font-size-14 font-weight-bold">Please Add
                                                        Product To WishList
                                                    </h5>
                                                </li>
                                ...
                                <ul class="list-unstyled px-2 pt-2">
                                    ...
                                    <li class="border-bottom pb-2 mb-3">
                                        <div class="">
                                            <ul class="list-unstyled d-flex ">
                                                <li class="li_img">
                                                    <img class="img-fluid" src="{{asset($row->options['image_url'])}}"
