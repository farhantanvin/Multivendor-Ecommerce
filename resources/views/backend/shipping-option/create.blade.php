...
@section("title","Create Shipping Option")
@section('content')
    <div class="fl-page-section">
        <div class="fl-input-section">
            <div class="card card_main_body">
                ...
                <form method="post" action="{{route("shipping-option.store")}}" class="submit-form" id="discount_form" enctype="multipart/form-data" data-parsley-validate>
                    @csrf
                    <div class="card-body">
                        <div class="fl-form">
                            <div class="form">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="md-form mt-0">
                                                            <input type="text" class="form-control" name="method_name" id="method_name" placeholder="Enter option name" value="{{old("method_name")}}" data-parsley-trigger="keyup" data-parsley-minlength="1" data-parsley-maxlength="250" data-parsley-required-message="The method name is required." required>
