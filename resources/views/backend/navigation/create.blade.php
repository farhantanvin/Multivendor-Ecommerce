                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{$errors->has("name") ? "is-invalid":""}}"
                                    id="name" name="name" placeholder="Enter Navigation name" value="{{old("name")}}">
                            ...
                            <div class="form-group select2-parent">
                                ...
                                <select name="position" id="position" class="form-control single-select2"
                                    ...
                                    <option @if(empty($position)) selected @endif disabled>Select Navigation
                                        Position
                                    </option>
                                    <option value="1" @if($position==1) selected @endif>Header Menu</option>
                                    <option value="2" @if($position==2) selected @endif>Middle</option>
                                    <option value="3" @if($position==3) selected @endif>Footer Menu</option>
                                </select>
                            ...
                            <div class="form-group select2-parent" id="footer_position">
                                ...
                                <select name="footer_position" class="form-control single-select2" style="width: 100%;"
                                    ...
                                    <option value="1" @if($footer_position==1) selected @endif>Left</option>
                                    <option value="2" @if($footer_position==2) selected @endif>Middle</option>
                                    <option value="3" @if($footer_position==3) selected @endif>Right</option>
                                </select>
                                <span class="text-danger">
                            ...
                            <div class="form-group select2-parent">
                                ...
                                <select name="type" id="type" class="form-control single-select2" style="width: 100%;"
                                    data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    <option @if(empty($type)) selected @endif disabled>Select Navigation Type
                                    </option>
                                    <option value="1" @if($type==1) selected @endif>Page</option>
                                    <option value="2" @if($type==2) selected @endif>Custom URL</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{$errors->has("serial") ? "is-invalid":""}}"
                                    id="serial" name="serial" placeholder="Enter Navigation serial"
                                    value="{{old("serial")}}">
                                <span class="text-danger">
