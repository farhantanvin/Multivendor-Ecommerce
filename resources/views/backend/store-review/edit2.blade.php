    ...
    <div class="fl-page-section">
        <div class="fl-input-section">
            <div class="card card_main_body">
                ...
                <form method="post" action="{{route("countries.update",$country->id)}}" class="submit-form" id="country_form" enctype="multipart/form-data" data-parsley-validate>
                    @method('put')
                    @csrf
                    <div class="card-body">
                        <div class="fl-form">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="md-form mt-0">
                                                            <input type="text" class="form-control" name="country_name" id="country_name" placeholder="Enter country name" value="{{old("country_name",$country->country_name)}}" data-parsley-trigger="keyup" data-parsley-minlength="1" data-parsley-maxlength="255" data-parsley-required-message="The country name is required." required>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <option value="0" @if(old("status", $country->status)==0) selected @endif>Inactive</option>
                                                        </select>
