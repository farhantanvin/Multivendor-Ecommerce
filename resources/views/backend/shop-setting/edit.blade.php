...
@section("title","Update Shop Setting")
@section('content')
    <div class="fl-page-section">
        <div class="fl-input-section">
            <div class="card card_main_body">
                ...
                <form method="post" action="{{route("shop-setting.update", $shopSetting->id ?? 0)}}" class="submit-form" id="shop_setting_form" enctype="multipart/form-data" data-parsley-validate>
                    @method('put')
                    @csrf
                    <div class="card-body">
                        <div class="fl-form">
                            <div class="form">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <p>
                                            <label for="image" style="cursor: pointer;">
                                                ...
                                                <img id="output" src="{{asset($shopSetting->logo)}}" width="200" />
                                                @else
                                    ...
                                    <div class="col-6">
                                        ...
                                        <p>
                                            <input name="banner" type="file" accept="image/*" class="banner" id="banner" style="display: none;">
                                        </p>
                                        <p>
                                            <label for="banner" style="cursor: pointer;">
                                            @if(!empty($shopSetting->banner))
                                            <img id="banner-show" src="{{asset($shopSetting->banner)}}" width="200" />
                                            @else
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <select class="browser-default custom-select form-control" name="status">
                                                    <option value="1" @if(old("status", $shopSetting->status ?? 2)==1) selected @endif>Active</option>
                                                    <option value="0" @if(old("status", $shopSetting->status ?? 2)==0) selected @endif>Inactive</option>
                                                </select>
