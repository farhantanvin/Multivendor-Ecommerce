        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><b>City List</b></h3>


                    <a href="{{route('city.create')}}" class="btn btn-primary float-right text-white">
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            @php
                                ...
                                $i = OwnLibrary::paginationSerial($cities);
                            @endphp
                                ...
                                <td class="text-center">
                                    <form method="post" action="{{route('city.destroy',$city->id)}}">
                                        <a class="btn btn-sm btn-warning text-white"
                                            href="{{route('city.edit',$city->id)}}" title="Edit">
                ...
                <div class="card-footer clearfix text-right">
                    {{$cities->links("backend.include.pagination")}}
                </div>
            </div>
        </div>
    </div>
