    ...
    <div class="fl-page-section">
        <div class="fl-input-section">
            <div class="card card_main_body">
                ...
                <form method="post" action="{{route("city.update",$city->id)}}" class="submit-form" id="state_form" enctype="multipart/form-data" data-parsley-validate>
                    @method('put')
                    @csrf
                    <div class="card-body">
                        <div class="fl-form">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select class="single-select2 browser-default custom-select form-control" name="state_id" id="state_id" style="width: 100%;" required="">
                                                        ...
                                                        @foreach($states as $state)
                                                            <option value="{{ $state->id }}" @if($city->state_id==$state->id) selected @endif>{{$state->state_name}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="md-form mt-0">
                                                            <input type="text" class="form-control" name="city_name" id="city_name" placeholder="Enter city name" value="{{old("city_name", $city->city_name)}}" data-parsley-trigger="keyup" data-parsley-minlength="1" data-parsley-maxlength="255" data-parsley-required-message="The city name is required." required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="browser-default custom-select form-control" name="status">
                                                            <option value="1" @if(old("status", $city->status)==1) selected @endif>Active</option>
                                                            <option value="0" @if(old("status", $city->status)==0) selected @endif>Inactive</option>
                                                        </select>
