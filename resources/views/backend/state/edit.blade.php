    ...
    <div class="fl-page-section">
        <div class="fl-input-section">
            <div class="card card_main_body">
                ...
                <form method="post" action="{{route("state.update", $state->id)}}" class="submit-form" id="state_form" enctype="multipart/form-data" data-parsley-validate>
                    @method('put')
                    @csrf
                    <div class="card-body">
                        <div class="fl-form">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select class="single-select2 browser-default custom-select form-control" name="country_id" id="country_id" style="width: 100%;" required="">
                                                        ...
                                                        @foreach($countries as $countrie)
                                                            <option value="{{ $countrie->id }}" @if($state->country_id==$countrie->id) selected @endif>{{$countrie->country_name}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="md-form mt-0">
                                                            <input type="text" class="form-control" name="state_name" id="state_name" placeholder="Enter state name" value="{{old("state_name", $state->state_name)}}" data-parsley-trigger="keyup" data-parsley-minlength="1" data-parsley-maxlength="255" data-parsley-required-message="The state name is required." required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="browser-default custom-select form-control" name="status">
                                                            <option value="1" @if(old("status", $state->status)==1) selected @endif>Active</option>
                                                            <option value="0" @if(old("status", $state->status)==0) selected @endif>Inactive</option>
                                                        </select>
