...
@section("title","Create Translation Language")
@section('content')
    <div class="fl-page-section">
        <div class="fl-input-section">
            <div class="card card_main_body">
                ...
                <form method="post" action="{{route("translation-language.store")}}" class="submit-form" id="translation_language_form" enctype="multipart/form-data" data-parsley-validate>
                    @csrf
                    <div class="card-body">
                        <div class="fl-form">
                            <div class="form">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="md-form mt-0">
                                                            <input type="text" class="form-control" name="language_name" id="language_name" placeholder="Enter language name" value="{{old("language_name")}}" data-parsley-trigger="keyup" data-parsley-minlength="1" data-parsley-maxlength="255" data-parsley-required-message="The language name is required." required>
