    ...
    <div class="fl-page-section">
        <div class="fl-input-section">
            <div class="card card_main_body">
                ...
                <form method="post" action="{{route("discount.update",$discount->id)}}" class="submit-form" id="discount_form" enctype="multipart/form-data" data-parsley-validate>
                    @method('put')
                    @csrf
                    <div class="card-body">
                        <div class="fl-form">
                                ...
                                <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="md-form mt-0">
                                                            <input type="text" class="form-control" name="name" id="name" placeholder="Enter discount title" value="{{old("name",$discount->name)}}" data-parsley-trigger="keyup" data-parsley-required-message="The title is required." required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="md-form mt-0">
                                                    <input type="text" class="form-control datetimepicker" id="start_date" name="start_date" placeholder="Enter start date" value="{{old("start_date", date("Y-m-d H:i", strtotime($discount->start_date)))}}" data-parsley-trigger="keyup" data-parsley-required-message="The start date is required." required autocomplete="off">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="md-form mt-0">
                                                    <input type="text" class="form-control" id="expired_date" name="expired_date" placeholder="Enter name" value="{{old("expired_date", date("Y-m-d H:i", strtotime($discount->expired_date)))}}" data-parsley-trigger="keyup" data-parsley-minlength="1" data-parsley-maxlength="250" data-parsley-required-message="The expired date is required." required required autocomplete="off">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="md-form mt-0">
                                                    <input type="text" class="form-control" id="validity_times" name="validity_times" placeholder="Enter use time" value="{{old("validity_times", $discount->validity_times)}}" data-parsley-trigger="keyup" data-parsley-minlength="1" data-parsley-maxlength="15" data-parsley-type="digits"data-parsley-required-message="The Use time is required." required>
                                        ...
                                        {{--<div class="row">--}}
                                            {{--<div class="col-md-12">--}}
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="md-form mt-0">
                                                            <textarea class="form-control" id="description" name="description" placeholder="Enter Description" data-parsley-trigger="keyup" data-parsley-minlength="1" data-parsley-maxlength="1000" data-parsley-required-message="The description is required." required>{{old("description",$discount->description)}}</textarea>
                                                            <span class="text-danger"> {{$errors->has("description", $discount->description) ? $errors->first("description") : ""}} </span>
                                                        </div>
                                                    </div>
                                                </div>
                                            {{--</div>--}}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <select class="browser-default custom-select form-control" name="coupon_type" id="coupon_type">
                                                    ...
                                                    <option value="all_user" @if(old("coupon_type" , $discount->coupon_type)=='all_user') selected @endif>All User</option>
                                                    <option value="specific_user" @if(old("coupon_type", $discount->coupon_type)=='specific_user') selected @endif>Specific User</option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <select class="browser-default custom-select form-control" name="status">
                                                    <option value="1" @if(old("status", $discount->status)==1) selected @endif>Active</option>
                                                    <option value="0" @if(old("status", $discount->status)==0) selected @endif>Inactive</option>
                                                </select>
                                    ...
                                    <div class="col-md-12 @if(old("coupon_type", $discount->coupon_type)=='all_user') invisible @endif" id="user_div">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="input-group mb-3">
                                                    <select class="single-select2 browser-default custom-select form-control" name="users[]" id="users" multiple="multiple" style="width: 100%;">
                                                        ...
                                                        elseif($discount->coupon_type=='specific_user'){
                                                            $return_arr = $selected_users;
                                                        }
                                                        ?>
