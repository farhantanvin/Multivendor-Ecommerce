    ...
    <div class="fl-page-section">
        <div class="fl-input-section">
            <div class="card card_main_body">
                ...
                <form method="post" action="{{route("vendor-page.store")}}" class="submit-form" id="shop_setting_form" enctype="multipart/form-data" data-parsley-validate>
                    @csrf
                    <div class="card-body">
                        <div class="fl-form">
                            <div class="form">
                                <div class="row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="md-form mt-0">
                                                    <input type="text" class="form-control" name="page_title" id="page_title" placeholder="Enter option name" value="{{old("page_title")}}" data-parsley-trigger="keyup" data-parsley-minlength="1" data-parsley-maxlength="500" data-parsley-required-message="The page title is required." required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="md-form mt-0">
                                                    <textarea class="form-control" id="description" name="description" placeholder="Enter Description" data-parsley-trigger="keyup" data-parsley-minlength="1" data-parsley-required-message="The description is required.">{{old("description")}}</textarea>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="md-form mt-0">
                                                    <input type="text" class="form-control" name="sl_no" id="sl_no"  placeholder="Enter serial number" value="{{old("sl_no")}}" data-parsley-trigger="keyup" data-parsley-minlength="1" data-parsley-maxlength="11" data-parsley-required-message="The Serial is required." data-parsley-type="digits" required>
